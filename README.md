...
V1 聚焦 Jeff 的 2026-06-02、2026-06-03、2026-06-08 和 2026-06-16 反馈：订单号登记、自动登记日期、输入订单号查询、出货核销自动日期、按细分类登记数量、待核销明细、先交要求、部分交付、返厂修改、急单置顶、数量汇总清晰显示、电脑和手机浏览器访问。
...
电脑端登记时输入一个订单号，选择公司和工厂，填写细分类数量、先交要求和可选备注，然后点“保存到订单总表”。
...
首页顶部会显示“待核销明细”，把未核销订单按套装、单衫、单裤、马甲和大衣分别汇总，并显示数量小计。
...
登记和修改订单时可以选择“先交要求”，例如“先交一套”“先交两套”“先交单衫”“先交单裤”等。

有先交要求的未核销订单会集中出现在左侧“先交”列表，订单行和手机详情页也会显示橙色“先交”标记。

“先交要求”是客户预先要求先做/先交什么；“部分交付”是已经交过一部分之后的实际记录，两者分开保存。
