...
V1 聚焦 Jeff 从 2026-06-02 到 2026-07-14 的实际使用反馈：订单号登记、自动登记日期、输入订单号查询、出货核销自动日期、按细分类登记数量、客户先交要求、可多次实际先交、剩余未交数量、紧凑订单详情、返厂修改、急单提示、电脑和手机浏览器访问。
...
- 最近操作：首页显示登记、更新客户先交要求、实际交货、撤销交货、出货核销、返厂修改、完成返厂、撤销核销等操作日志，也可进入 `/events` 查看最近 500 条。
